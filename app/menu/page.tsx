...
const menuItems = [
  ...
  { id: '32', name: 'Panko Chicken',                    description: '', price: 309, category: 'starters',  image: '', isVeg: false },
  ...
  { id: '44', name: 'Mix Veg Koorma',                     description: '', price: 249, category: 'main-course', image: '', isVeg: true  },
  ...
  { id: '52', name: 'Veg Kolhapuri',                      description: '', price: 269, category: 'main-course', image: '', isVeg: true  },
  ...
  { id: '61', name: 'Chicken Koorma',                     description: '', price: 299, category: 'main-course', image: '', isVeg: false },
  ...
  { id: '77', name: 'Malai Paneer Tikka',         description: '', price: 249, category: 'tandoori', image: '', isVeg: true  },
  ...
  { id: '96', name: 'Panko Fish',                description: '', price: 369, category: 'seafood', image: '', isVeg: false },
  ...
  { id: '100', name: 'Panko Prawns',              description: '', price: 369, category: 'seafood', image: '', isVeg: false },
  ...
  { id: '108', name: 'Pudina Naan',                        description: '', price: 39,  category: 'breads',      image: '', isVeg: true  },
  ...
  // Noodles & Fried Rice
  { id: '113', name: 'Jeera Rice',                        description: '', price: 179, category: 'noodleAndFriedRice', image: '', isVeg: true  },
  { id: '114', name: 'Veg Soft Noodles',                  description: '', price: 179, category: 'noodleAndFriedRice', image: '', isVeg: true  },
  { id: '115', name: 'Veg Fried Rice',                    description: '', price: 179, category: 'noodleAndFriedRice', image: '', isVeg: true  },
  { id: '116', name: 'Veg Schezwan Noodles',              description: '', price: 189, category: 'noodleAndFriedRice', image: '', isVeg: true  },
  { id: '117', name: 'Veg Schezwan Fried Rice',           description: '', price: 189, category: 'noodleAndFriedRice', image: '', isVeg: true  },
  { id: '118', name: 'Veg Tikka Noodles',                 description: '', price: 209, category: 'noodleAndFriedRice', image: '', isVeg: true  },
  { id: '119', name: 'Paneer Fried Rice',                 description: '', price: 209, category: 'noodleAndFriedRice', image: '', isVeg: true  },
  { id: '120', name: 'Veg Manchurian Fried Rice',         description: '', price: 209, category: 'noodleAndFriedRice', image: '', isVeg: true  },
  { id: '121', name: 'Veg Manchuria Noodles',             description: '', price: 209, category: 'noodleAndFriedRice', image: '', isVeg: true  },

  { id: '122', name: 'Egg Noodles',                       description: '', price: 189, category: 'noodleAndFriedRice', image: '', isVeg: false },
  { id: '123', name: 'Egg Fried Rice',                    description: '', price: 189, category: 'noodleAndFriedRice', image: '', isVeg: false },
  { id: '124', name: 'Chicken Soft Noodles',              description: '', price: 209, category: 'noodleAndFriedRice', image: '', isVeg: false },
  { id: '125', name: 'Chicken Hakka Noodles',             description: '', price: 209, category: 'noodleAndFriedRice', image: '', isVeg: false },
  { id: '126', name: 'Chicken Fried Rice',                description: '', price: 209, category: 'noodleAndFriedRice', image: '', isVeg: false },
  { id: '127', name: 'Chicken Schezwan Noodles',          description: '', price: 229, category: 'noodleAndFriedRice', image: '', isVeg: false },
  { id: '128', name: 'Chicken Schezwan Fried Rice',       description: '', price: 229, category: 'noodleAndFriedRice', image: '', isVeg: false },
  { id: '129', name: 'Mix Non Veg Fried Rice',            description: '', price: 259, category: 'noodleAndFriedRice', image: '', isVeg: false },
...
// Special Combos for 4 Persons
  ...
  // Pulaos (veg)
  { id: '133', name: 'Mix Veg Pulao',                     description: '', price: 249, category: 'pulao',       image: '', isVeg: true  },
  { id: '134', name: 'Kaju Paneer Pulao',                 description: '', price: 299, category: 'pulao',       image: '', isVeg: true  },
  { id: '135', name: 'Pachimirchi Paneer Pulao',          description: '', price: 279, category: 'pulao',       image: '', isVeg: true  },
  { id: '136', name: 'Mushroom Pulao',                    description: '', price: 279, category: 'pulao',       image: '', isVeg: true  },
  { id: '137', name: 'Ulavacharu Pulao',                    description: '', price: 279, category: 'pulao',       image: '', isVeg: true  },

  // Pulaos (non veg)
  { id: '138', name: 'Military Kodi Pulao',               description: '', price: 299, category: 'pulao',       image: '', isVeg: false },
  { id: '139', name: 'Mutton Pulao',                      description: '', price: 349, category: 'pulao',       image: '', isVeg: false },
  { id: '140', name: 'Fish Pulao',                        description: '', price: 379, category: 'pulao',       image: '', isVeg: false },
  { id: '141', name: 'Prawns Pulao',                      description: '', price: 379, category: 'pulao',       image: '', isVeg: false },
  { id: '142', name: 'Achari Kodi Pulao',                  description: '', price: 299, category: 'pulao',       image: '', isVeg: false },
  { id: '143', name: 'Ulavacharu Kodi Pulao',                  description: '', price: 309, category: 'pulao',       image: '', isVeg: false },


  // Rice & Biryani → Biryani
  { id: '144', name: 'Mix Veg Biryani',                   description: '', price: 239, category: 'rice',       image: '', isVeg: true  },
  { id: '145', name: 'Paneer Biryani',                    description: '', price: 259, category: 'rice',       image: '', isVeg: true  },
  { id: '146', name: 'Mushroom Biryani',                  description: '', price: 259, category: 'rice',       image: '', isVeg: true  },
  { id: '147', name: 'Kaju Paneer Biryani',               description: '', price: 299, category: 'rice',       image: '', isVeg: true  },
  { id: '148', name: 'Kaju Biryani',                      description: '', price: 309, category: 'rice',       image: '', isVeg: true  },
  { id: '149', name: 'Babycorn Biryani',                  description: '', price: 259, category: 'rice',       image: '', isVeg: true  },
  { id: '150',name: 'Curd Rice',                         description: '', price: 159, category: 'rice',       image: '', isVeg: true  },

  { id: '151', name: 'Egg Biryani',                       description: '', price: 249, category: 'rice',       image: '', isVeg: false },
  { id: '152', name: 'Chicken Biryani (Single)',          description: '', price: 169, category: 'rice',       image: '', isVeg: false },
  { id: '153', name: 'Chicken Biryani (Full)',            description: '', price: 299, category: 'rice',       image: '', isVeg: false },
  { id: '154', name: 'Chicken Biryani (Family)',          description: '', price: 599, category: 'rice',       image: '', isVeg: false },
  { id: '155', name: 'Chicken Fry Piece Biryani',         description: '', price: 319, category: 'rice',       image: '', isVeg: false },
  { id: '156', name: 'Chicken Special Biryani',           description: '', price: 319, category: 'rice',       image: '', isVeg: false },
  { id: '157', name: 'Chicken Potlam Biryani',            description: '', price: 359, category: 'rice',       image: '', isVeg: false },
  { id: '158', name: 'Lollipop Biryani',                  description: '', price: 359, category: 'rice',       image: '', isVeg: false },
  { id: '159',name: 'Gongura Chicken Biryani',           description: '', price: 339, category: 'rice',       image: '', isVeg: false },
  { id: '160',name: 'Chicken Tikka Biryani',             description: '', price: 339, category: 'rice',       image: '', isVeg: false },
  { id: '161',name: 'Tangdi Biryani',                    description: '', price: 349, category: 'rice',       image: '', isVeg: false },
  { id: '162',name: 'Mutton Biryani (Single)',           description: '', price: 199, category: 'rice',       image: '', isVeg: false },
  { id: '163',name: 'Mutton Biryani (Full)',             description: '', price: 369, category: 'rice',       image: '', isVeg: false },
  { id: '164',name: 'Mutton Biryani (Family)',           description: '', price: 749, category: 'rice',       image: '', isVeg: false },
  { id: '165',name: 'Gongura Mutton Biryani',            description: '', price: 379, category: 'rice',       image: '', isVeg: false },
...
export default function MenuPage() {
  ...
  return (
      <div className="min-h-screen pt-20 pb-16">
         {/*Hero Section */}
        <section className="relative py-20 bg-cover bg-center" style={{ backgroundImage: './images/Menu.jpg' }}>
